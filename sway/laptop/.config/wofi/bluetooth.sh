...
# Edited by github/luanc202
# I replaced all rofi calls to wofi 
# If you wish to use rofi again, just replace and it will work
...
wofi_command="wofi -dmenu -no-fixed-num-lines -yoffset -100 -i -p"
